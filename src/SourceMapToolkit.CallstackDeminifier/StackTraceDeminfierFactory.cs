...
namespace SourcemapToolkit.CallstackDeminifier
{
    public class StackTraceDeminfierFactory
    {
        ...
        public static StackTraceDeminifier GetMyStackTraceDeminfier(ISourceMapProvider sourceMapProvider)
        {
            var sourceMapStore = new SourceMapStore(sourceMapProvider);
            var stackFrameDeminifier = new MyStackFrameDeminifier(sourceMapStore);
